...
import { Typography, Space, Button, Card, Col, Row, Flex } from 'antd';
...
const App: React.FC = () => {
  ...
  const handleCalc = () => {
    ...
    if (hasInvalid) {
      setErrorMessage(
        'Erro: preencha todas as medidas comporais com números maiores que zero.'
      );
      return;
    }
  ...
  return (
    ...
    >
      <Typography.Title
        level={1}
        style={{ textAlign: 'center', margin: '0 0 40px' }}
      >
        Calculadora Física
      </Typography.Title>
      ...
      <div style={{ border: '1px solid black', padding: '40px' }}>
        ...
        >
          <Col span={12}>
            <Typography.Title level={2} style={{ margin: '0 0 20px' }}>
              Informações Básicas
            </Typography.Title>
            <BasicInfo
              name={name}
